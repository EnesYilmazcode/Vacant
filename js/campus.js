...
//
// Grid values are NOT bounded to 0..grid. The fetch asks for shapes that
// INTERSECT the bounding box, so a road or a river crossing the edge comes back
// whole: measured range on the shipped file is -11080 to 61621 against a grid
// of 65535. A renderer must clip rather than assume. Clamping here would tear
// shapes apart at the boundary, which looks worse than drawing past the edge.
//
// Runs in the browser and under node, no imports.

// Grid steps for one shape, as [x, y] pairs. Cheap enough to call per frame,
...
// Grid space is square, but a degree of longitude is shorter than a degree of
// latitude, so drawing it square stretches campus east to west. At 40 degrees
// north the ratio is cos(40) = 0.766.
