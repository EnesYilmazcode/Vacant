...
// `git show HEAD:<file> | gzip -9 -c | wc -c` on gzip 1.14, re-measured on gzip
// 1.12 when the location watch landed. Shell 87,588 bytes, data 85,157. The data side more than doubled when the index started carrying
