...
// `git show HEAD:<file> | gzip -9 -c | wc -c`. Shell 138,137 bytes, data 91,951.
...
// list you scan, which cost another 4,443: 2,941 on js/app.js for the deck, the
// two verdicts and the gesture, and 1,502 on index.html for the card itself.
//
...
const SHELL_CACHE = 'vacant-shell-bb2d30e';
...
// argued half: the four are 25,425 of the 138,137 gzipped bytes here, so
// install does 22.6% more work before it resolves, and a strict tier that fails
